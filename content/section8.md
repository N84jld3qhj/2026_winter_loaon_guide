...
돌파고에 물어보면 0.136% 정도라고 나오는데 굉장히 낮은 확률이죠.
...
연마 효과가 메인인데 연마 효과는 같은 옵션이라도 등급에 따라 효과가 다릅니다. 

그리고 옵션은 중복해서 나오지 않기 때문에 유효 옵션 중 높은 등급의 옵션을 가진 장신구를 사용해야 합니다.

예를들어 딜러의 경우 귀걸이에서 유효 옵션으로 공격력 % 와 무기 공격력 %가 있고 이 2개의 옵션이 어떻게 붙었느냐에 따라 상상/상중/상단일/중중 등 장신구의 효과가 결정됩니다. 
...
* 각 젬은 활성화에 필요한 **필요 의지력**(예: 8, 9, 10)을 가지고 있습니다.
* 코어와 가까운 젬부터 순서대로 의지력이 전달됩니다.
* 코어 등급(전설/유물/고대)이 높을수록 의지력이 많아져 **더 많은 젬을 동시에 활성화**할 수 있습니다.
* **주의:** 의지력이 부족하여 비활성화된 젬은 전투 옵션과 코어 포인트가 모두 적용되지 않습니다.
